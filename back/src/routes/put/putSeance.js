...
router.put('/seances', jwtManager.verifyToken, function (req, res) {
    ...
    connexion.query(sql, [idIntervenant, idCreneau, 0, durreEffective, 0, commentaire ], function (err, data, fields) {
