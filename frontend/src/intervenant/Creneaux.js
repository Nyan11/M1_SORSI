...
async function modifier(itemNew, itemOld) {
  return await Service.updateCours(itemNew).then(data => data.json())
}
async function supprimer(item) {
  return await Service.deleteCours(item).then(data => data.json())
}
async function ajouter(item) {
  return await Service.createCours(item).then(data => data.json())
}
async function updateView() {
  return await Service.createCours(null).then(data => data.json())
}
